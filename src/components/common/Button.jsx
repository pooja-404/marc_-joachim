...
export default function Button(props) {
    return (
        <div className="max-lg:flex justify-center">
            <button className={`${props.name} z-10 relative bg-bg-gradient flex h-[50px] font-inter font-medium sm:text-base text-[15px] md:leading-[24px] hover:shadow-[0px_2px_8px_0px_#000] duration-500 text-[#FDFDFF]  p-[14px_17px_14px_17px] sm:p-[12px_24px_28px_24px]`}>
