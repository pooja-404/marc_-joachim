...
export default function Cards() {
    ...
    const productcard = [
        {
            text: "Your self-esteem is in the basement."
        },
        {
            text: "You keep asking yourself what you did wrong."
        },
        {
            text: "The feeling of helplessness is your constant companion."
        },
    ];
    const list = productcard.map((productcard, p) => (
        <div className="lg:w-4/12 sm:w-1/2 w-full mx-auto">
            <div className="lg:max-w-[250px] mx-auto lg:h-[162px] md:[120px] h-[100px] sm:text-base text-[15px] w-full bg-[#003E9233] hover:bg-[#003E92] flex px-5 duration-500 backdrop-blur-[3px] items-center" key={p} >
                <p className='font-poppins font-normal z-10 sm:text-base text-[15px] lg:leading-[25px] text-white '>{productcard.text}</p>
            </div>
        </div>
    ));
    return (
