    ...
    return (
        <>
            <div className="max-w-[1140px] 2xl:max-w-[1320px]  container relative  px-3 mx-auto ">
                <p className="text-[#000000]  sm:text-xl text-lg  font-normal leading-[28px] pt-12  font-poppins text-center">You are not alone! Numerous women before you stood exactly at this point, where you are now.</p>
                <div className="flex items-center gap-2 mt-5">
                    <div className="mx-auto">
                        <div className=" bg-bg-gradient cursor-pointer hover:shadow-[0px_2px_8px_0px_#003E92] duration-300 p-[1.7px] max-w-[452px] h-[59px] w-full rounded-[63px]">
                ...
                <div className="md:flex items-center gap-5  lg:pt-24">
                    <div className="pt-5 flex items-center  justify-center">
                        ...
                        <Image
                            ...
                            height={224}
                            width={216} className="md:bl ock hid den"
                        />
                    </div>
