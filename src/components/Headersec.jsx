    ...
    return (
        ...
        <div className="flex-grow flex justify-center relative  items-center">
            <div className="max-w-[1140px] 2xl:max-w-[1320px]  container px-3 mx-auto ">
                ...
                <p className="sm:text-base text-[15px] hover:shadow-[0px_2px_48px_0px_##003E92] font-poppins font-normal leading-[25px] text-[#4d4d4d] ">For women who do not want to be completely dragged down <span className="lg:block">by a SEPARATION.</span>
            ...
            <div className="flex mx-auto  absolute lg:bottom-10 bottom-0 my-3 max-lg:left-0 lg:right-[24rem]   pt-2  px-5 gap-9 ">
                <div className="flex items-center gap-2">
                    <div className="w-[2px] h-[65px] bg-[#9800B0]"></div>
                    <ul>
                        <li className="sm:text-base text-[15px] font-normal leading-[24px] font-helve text-[#f3efef] uppercase">Die wichtigsten</li>
                        <li className="sm:text-base text-[15px] font-normal leading-[24px] font-helve text-[#f3efef] uppercase">Aspekte einer</li>
                        <li className="sm:text-base text-[15px] font-normal leading-[24px] font-helve text-[#f3efef] uppercase">Trennung:</li>
                    </ul>
                </div>
                <ul>
                    <li className="list-disc sm:text-base text-[15px] text-white font-medium leading-[24px] font-helve capitalize ">physische Trennung</li>
                    <li className="list-disc sm:text-base text-[15px] text-white font-medium leading-[24px] font-helve capitalize">mentale Trennung</li>
                </ul>
            </div>
        </div>
    )
